...
Notes:      Version 3: Block AI + Block human, s = orange, d = blue
"""
...
for idx, row in cond_df_ai.iterrows():
    ...
    # Save trail info
    AIexp.addData('Version', '3(BlockAI+Blockhuman,s=orange,d=blue)')
...
display_instructions(file = my_directory + "/instructions/blockswitch_so_ai.JPG")
