...
Notes:      Version 2: Block H + Block AI, d = orange, s = blue
"""
...
for idx, row in cond_df_h.iterrows():
    ...
    # Save trail info
    AIexp.addData('Version', '2(Blockhuman+BlockAI,d=orange,s =blue)')
...
display_instructions(file = my_directory + "/instructions/blockswitch_do_h.JPG")
